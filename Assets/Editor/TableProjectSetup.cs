...
public static class TableProjectSetup
{
    ...
    public static string RunCoreChecks()
    {
        ...
        var g=new TableRun(rules);g.Reset(33);g.SkipStamp();
        ...
        g.Reset(33);g.SkipStamp();g.coins=1000;int rarity=g.Stars(18);int price=g.UpgradeCost(18),money=g.coins;
        ...
        g.Reset(33);g.SkipStamp();g.LeaveWorkshop();g.hand.Clear();g.hand.AddRange(cards(new[]{10,8}));
        ...
        g.Advance();check(g.phase==RunPhase.Stamp,"Stamp workshop every two hands");g.SkipStamp();
        ...
        g.Reset(33);g.SkipStamp();g.LeaveWorkshop();check(g.hand.Count==2&&g.shoe.Count==24,"Deal removes exactly2");
        ...
        g.Advance();check(g.stage==1&&g.stageScore==0&&g.handsPlayed==0&&g.phase==RunPhase.Stamp,"Stage transition opens stamp workshop");
        ...
        g.Reset(33);g.SkipStamp();check(g.levels[18]==1&&!g.unlocked[33]&&g.deck.Count==26&&g.streak==0,"Fresh run resets progression");
        ...
        g.Reset(33);g.SkipStamp();g.phase=RunPhase.Playing;g.stageScore=500;g.streak=2;
        ...
        g.Reset(33);g.SkipStamp();g.phase=RunPhase.Playing;g.unlocked[33]=true;
        ...
        g.Reset(33);g.SkipStamp();g.phase=RunPhase.Playing;g.hand.AddRange(cards(new[]{4,1}));g.hand[1].aceChoice=11;
        g.shoe.Add(new PlayingCard(100,9,0));g.Hit();
        check(g.SetAce(1,0)&&g.Current.total==14&&!g.NeedsAceChoice,"AUTO also rescues fixed11");
        g.Reset(33);g.SkipStamp();g.phase=RunPhase.Playing;g.hand.AddRange(cards(new[]{10,10,1}));
        ...
        {
            g.Reset(33);g.SkipStamp();g.phase=RunPhase.Result;g.handsPlayed=rules.handsPerStage-remaining;g.stageScore=g.Target;money=g.coins;
        ...
        g.Reset(33);g.SkipStamp();g.stage=rules.stageTargets.Length-1;g.phase=RunPhase.Result;g.handsPlayed=3;g.stageScore=g.Target;money=g.coins;
        ...
        g.Reset(33);g.SkipStamp();g.phase=RunPhase.Result;g.handsPlayed=rules.handsPerStage;money=g.coins;g.Advance();check(g.phase==RunPhase.Defeat&&g.coins==money,"Defeat awards no clear coins");
        ...
        g.Reset(33);g.SkipStamp();g.levels[3]=5;g.streak=5;
        ...
        g.Reset(33);g.SkipStamp();g.coins=1000;int lastCost=g.RemoveCost;
